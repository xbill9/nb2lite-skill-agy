#!/usr/bin/env python3
"""Refresh the bundled nb2lite-image skill snapshots from the repo-root sources.
...
Regenerates:
  ...
  .claude/skills/nb2lite-image/        assembled from SKILL.md + mcp/ + references/
...
SKILL = ROOT / ".gemini" / "antigravity-cli" / "skills" / "nb2lite-image"
